...
describe('dragonnode.js', function () {
    ...
    it('should give a npm module his configuration', function () {
        ...
        var services = {};
        dragonnodejs(environmentconfig, services);
        assert.equal(services.moduleconfig.c, 'c', 'module should have "c" from configuration');
        assert.equal(services.moduleconfig.d, 'd', 'module should have "d" from configuration');
    });
    ...
    it('should give a directory module his configuration', function () {
        ...
        var services = {};
        dragonnodejs(environmentconfig, services);
        assert.equal(services.moduleconfig.a, 'a', 'module should have "a" from configuration');
        assert.equal(services.moduleconfig.b, 'b', 'module should have "b" from configuration');
    });
